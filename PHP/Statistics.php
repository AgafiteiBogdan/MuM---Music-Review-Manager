...
<nav class="navbar">
     <span class="navbar-toggle" id="js-navbar-toggle">
        ...
        <ul class="main-nav" id="js-menu">
            ...
            <li>
              <p><a href="My account.php" class="nav-links">Log in</a></p>
            </li>
        </ul>
</nav>
...
<div class = "statistici" >
  ...
  if($result = mysqli_query($db,$sql)){
    ...
    $artist = $row['aname'];
    ?>
    <p> The most favorite song is <?php echo $song?> , singed by <?php echo $artist ?>, it is favorited by <?php echo $nr_aparitii ?> people.<p>
    <?php
  }
  ...
  if($result = mysqli_query($db,$sql)){
    ...
    $artist = $row['aname'];
    ?>
    <p> The most commented song is <?php echo $song ?> singed by <?php echo $artist ?>, it has <?php echo $nr_aparitii ?> comments.<p>
    <?php
  }
  ...
  if($result = mysqli_query($db,$sql)){
    ...
    $user = $row['user'];
    ?>
    <p>The most active user is <?php echo $user ?>, he added <?php echo $nr_aparitii ?> comments.<p>
    <?php
  }
  ...
  if($result = mysqli_query($db,$sql)){
    ...
    $artist = $row['aname'];
    ?>
    <p> The artist that has the most songs added to favorite by users is <?php echo $artist ?> , his songs are added at favorite <?php echo $nr_aparitii?> times.<p>
    <?php
  }
  ...
  if($result = mysqli_query($db,$sql)){
    ...
    $artist = $row['aname'];
    ?>
    <p> The most favorited artist is <?php echo $artist?> , being added as favorite by <?php echo $nr_aparitii ?> users .<p>
    <?php
  }
