...
<nav class="navbar">
     <span class="navbar-toggle" id="js-navbar-toggle">
        ...
        <ul class="main-nav" id="js-menu">
            ...
            <li>
                <a href="Home.php(Admin)" class="nav-links">Home</a>
            </li>
            <li>
                <a href="News.php(Admin)" class="nav-links">News</a>
            </li>
            <li>
...
<div class="sidebar" id="sidebar">
  ...
  <a href="Genres(Admin).php" class="active"><i class="fa fa-ellipsis-v" id="image"></i>Genres</a>
