...
<div class="sidebar" id="sidebar">
  ...
  <a href="My favorite songs(Admin).php"  class="active"><i class="fa fa-star" id="image"></i>My favorite songs</a>
...
<?php   require 'update.php';
       ...
       $sql =  "SELECT song_id as 'id' , s.name as 'song', a.name as 'artist', alb.name as 'album', alb.release_year as 'year', s.genre as 'genre' from favorite_songs  join songs s on s.id = song_id join artists a on s.artist_id = a.id join albums alb on s.album_id = alb.id where username = '$username' order by song_id, s.name, s.genre ";
